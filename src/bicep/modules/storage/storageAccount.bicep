...
@description('Provide value if you want to storage account name')
param p_manualStorageAcctName string =''

///////////////////////////////////////////////////////////////////////////////////////////////////////
// Section for Bicep variables
///////////////////////////////////////////////////////////////////////////////////////////////////////

var v_partialStorageAccountName = (empty(p_partialStorageAccountName) ? '' : p_partialStorageAccountName)
var v_uniqueStorageName = toLower(replace('sa${v_partialStorageAccountName}${uniqueString(resourceGroup().id)}', '-', ''))
var v_storageAccountName = take((empty(p_manualStorageAcctName) ? v_uniqueStorageName : p_manualStorageAcctName),24)
