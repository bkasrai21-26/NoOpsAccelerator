...
resource sqlAuditSettings 'Microsoft.Sql/servers/auditingSettings@2021-05-01-preview' = {
    name: 'default'
    parent: sqlServer
    properties: {
  ...
  resource sqlDevOpsAuditSettings 'Microsoft.Sql/servers/devOpsAuditingSettings@2021-05-01-preview' = {
    name:'default'
    parent: sqlServer
    properties: {
      isAzureMonitorTargetEnabled: p_isAzureMonitorTargetEnabled
